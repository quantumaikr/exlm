...
model = PlanktonForCausalLM.from_pretrained('quantumaikr/plankton-500M', cache_dir="hub")
...
train_dataset = load_dataset('nlpai-lab/kullm-v2', split="train[:1000]", cache_dir="hub")
kullm_train_dataset = load_tokenized_dataset(tokenizer, 'alpaca', train_dataset)

train_dataset = load_dataset('FreedomIntelligence/alpaca-gpt4-korean', split="train[:1000]", cache_dir="hub")
